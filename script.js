...
const ratioButton = document.querySelector('[data-ratio]');
const base2Button = document.querySelector('[data-base2]');
const baseXButton = document.querySelector('[data-baseX]');
